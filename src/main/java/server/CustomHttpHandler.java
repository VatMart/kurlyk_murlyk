...
public abstract class CustomHttpHandler extends ChannelInboundHandlerAdapter {
    ...
    private final List<CustomMethodHandler> httpMethodHandlers;
    ...
    public CustomHttpHandler(JsonParser parser) {
        this.parser = parser;
        httpMethodHandlers = initHandler();
    }

    private List<CustomMethodHandler>  initHandler() {
        List<CustomMethodHandler> handlers = new ArrayList<>();
                ...
                try {
                    ...
                    if (path != null) {
                        ...
                        for (Parameter parameter : method.getParameters()) {
                            ...
                            if (parameter.getType().getSimpleName().equals("HttpRequest")) continue;
                        ...
                        handlers.add(new CustomMethodHandler(httpMethod, path, method,
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        if (httpMethodHandlers != null && msg instanceof HttpRequest) {
            ...
            for (CustomMethodHandler handler : httpMethodHandlers) {
                ...
                if (handler.getHttpMethod().equals(request.method()) && matcher.matches()) {
                    ...
                    if (handler.getParams() != null && !handler.getParams().isEmpty()) {
                        ...
                        parameters = new Object[handler.getParams().size()+1]; //
                    ...
                    parameters[handler.getParams().size()] = request;
